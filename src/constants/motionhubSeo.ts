...
/** 한국 시장 대외 노출명 */
export const MOTIONHUB_BRAND_KO = '모션 허브'
...
export const MOTIONHUB_TRUST_LINE =
  '모션 허브는 현장 PT 센터 운영 경험을 바탕으로 만들어졌습니다.'
...
export const MOTIONHUB_SEO = {
  title: '모션 허브 | 운동센터 AI 운영 플랫폼',
  description:
    '모션 허브(MotionHub)는 회원관리·예약·출석·결제·알림톡·AI 운영비서를 하나로 연결하는 운동센터 AI Operating System입니다. 무료 세팅 후 14일 체험.',
  ogTitle: '모션 허브 | 운동센터 AI 운영 플랫폼',
  ogDescription:
    '운영은 모션 허브에게 맡기고 회원에게 집중하세요. Today Feed로 오늘 할 일을 바로 처리합니다.',
...
export const MOTIONHUB_GUIDE_SEO = {
  title: '모션 허브 시작 가이드',
  description:
    '운동센터 운영을 위한 모션 허브 초기 설정 및 이용 방법 안내',
  ogTitle: '모션 허브 시작 가이드',
  ogDescription:
    '운동센터 운영을 위한 모션 허브 초기 설정 및 이용 방법 안내',
  canonicalPath: '/guide',
} as const
