...
export function ExerciseVillagePage({ memberId, refreshToken = 0 }: Props) {
  ...
  if (world.loading) {
    return (
      <div className="flex h-[min(88dvh,720px)] items-center justify-center rounded-2xl bg-[#1a2f1a]/80 text-sm text-cream/70">
        운동 세계를 불러오는 중…
      </div>
    )
  }
  ...
  return (
    <div className="relative flex h-[min(88dvh,920px)] min-h-[480px] flex-col">
      <WorldMapViewport
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 z-10 px-1.5 pt-1.5">
        <div className="pointer-events-auto">
          <VillageHudBar
            ...
            currentMile={world.currentMile}
            currentAcorns={world.currentAcorns}
